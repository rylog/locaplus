    ...
    <div className={'w-10 fixed bottom-0 left-4 right-auto z-10 text-gray-400'}>
      <ul>
        <li className="flex justify-center items-center mb-6 mx-auto text-gray-400 hover:text-slate-500 mix-blend-difference relative group">
          ...
          <span className="text-gray-300 group-hover:inline-block hidden absolute left-10 top-1/2 transform -translate-y-1/2 bg-black px-3 py-1 rounded-md">
            facebook.com
          </span>
        </li>
        <li className="flex justify-center items-center mb-6 mx-auto text-gray-400 hover:text-slate-500 mix-blend-difference relative group ">
        ...
        <li className="flex justify-center items-center mb-6 mx-auto text-gray-400 hover:text-slate-500 mix-blend-difference relative group">
          <a
            ...
            onClick={() =>
              (window.location.href = 'mailto:yourmail@locaplus.net')
            }
          >
